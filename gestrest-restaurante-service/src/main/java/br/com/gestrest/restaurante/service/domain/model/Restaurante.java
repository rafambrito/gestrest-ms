...
public class Restaurante {
	...
	private Restaurante(Long id, String nome, String endereco, String tipoCozinha, String horarioFuncionamento, Long donoId, boolean ativo) {
	...
	public static Restaurante criar(String nome, String endereco, String tipoCozinha, String horarioFuncionamento, Long donoId, boolean ativo) {
		return new Restaurante(null, nome, endereco, tipoCozinha, horarioFuncionamento, donoId, ativo);
	}

	public static Restaurante existente(Long id, String nome, String endereco, String tipoCozinha, String horarioFuncionamento, Long donoId, boolean ativo) {
		return new Restaurante(id, nome, endereco, tipoCozinha, horarioFuncionamento, donoId, ativo);
	}

	public void atualizar(String nome, String endereco, String tipoCozinha, String horarioFuncionamento, boolean ativo) {
