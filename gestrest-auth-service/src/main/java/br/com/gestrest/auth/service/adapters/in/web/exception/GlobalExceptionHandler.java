package br.com.gestrest.auth.service.adapters.in.web.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleBadRequest(RuntimeException ex, WebRequest request) {
