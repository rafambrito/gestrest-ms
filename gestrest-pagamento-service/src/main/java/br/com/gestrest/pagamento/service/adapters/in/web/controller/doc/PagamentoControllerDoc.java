...
public interface PagamentoControllerDoc {
        ...
        @Operation(summary = "Consultar pagamento por id", description = "Retorna os dados de um pagamento previamente processado")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Pagamento encontrado", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PagamentoResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Pagamento não encontrado")
        })
        ResponseEntity<PagamentoResponse> buscarPorId(
